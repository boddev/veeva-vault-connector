...
| **Cross-Tenant** | Set `AZURE_HOSTING_TENANT_ID` if Azure sub is in a different tenant than M365 | Leave blank for single-tenant; script handles login to both tenants automatically |
